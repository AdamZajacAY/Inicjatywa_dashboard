...
| Rola | Zakres |
|---|---|
| **Architekt** (dawniej „Specjalista” — wartość `Specjalista` w bazie, nazwa wyświetlana zmieniona) | Podgląd całego portfela (bez danych finansowych — budżet/marża/stawki godzinowe są ukryte), zgłaszanie i edycja własnych ticketów w projektach, do których jest przypisany. |
