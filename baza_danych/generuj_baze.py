...
# ===========================================================================
# 2) ZESPOL (osoby zebrane z notatek 4 lideröw zespolow: Osoba A, Osoba D, Osoba H, Osoba J)
# ===========================================================================
...
team_rows = [
    ["P01", "Osoba A", "Architekt / Lider zespolu", "Kierownictwo projektow", None, None, 100, None, "Tak"],
    ["P02", "Osoba B", "Architekt", "Architekci", None, None, 100, None, "Tak"],
    ["P03", "Osoba C", "Architekt", "Architekci", None, None, 100, None, "Tak"],
    ["P04", "Osoba D", "Architekt / Lider zespolu", "Kierownictwo projektow", None, None, 100, None, "Tak"],
    ["P05", "Osoba E", "Architekt (wsparcie)", "Architekci", None, None, 100, None, "Tak"],
    ["P06", "Osoba F", "Architekt", "Architekci", None, None, 100, None, "Tak"],
    ["P07", "Osoba G", "Architekt", "Architekci", None, None, 100, None, "Tak"],
    ["P08", "Osoba H", "Architekt / Lider zespolu (Nadzor autorski)", "Kierownictwo projektow", None, None, 100, None, "Tak"],
    ["P09", "Osoba I", "Specjalista (wsparcie)", "Specjalisci", None, None, 100, None, "Tak"],
    ["P10", "Osoba J", "Architekt / Lider zespolu", "Kierownictwo projektow", None, None, 100, None, "Tak"],
    ["P11", "Osoba K", "Specjalista (kontakt z inwestorem)", "Specjalisci", None, None, 100, None, "Tak"],
    ["P12", "Osoba L", "Specjalista (wsparcie, dochodzaco)", "Specjalisci", None, None, 100, None, "Tak"],
]
...
proj_rows = [
    ["JB-01", "Projekt JB-01", "Projekt wykonawczy", "Projektant wiodacy", None, "Osoba A", "Osoba A",
     "W realizacji", "Projektowanie", None, "Zielony",
     None, None, None, None, None, None, "PLN", None, None,
     "ul. Przykladowa 1", None, None, None,
     "Klient A", "Projekt budowlany i projekt wykonawczy budynku dla Klient A.",
     None, U, "[Zrodlo: Osoba A] Zespol: Osoba A (lider), Osoba B, Osoba C."],

    ["JB-02", "Projekt JB-02", "Nadzor autorski", "Nadzor autorski", None, "Osoba A", "Osoba A",
     "W realizacji", "Budowa", None, "Zielony",
     None, None, None, None, None, None, "PLN", None, None,
     "ul. Przykladowa 2", None, None, None,
     "Klient A", "Nadzor autorski na budowie dla Klient A.",
     None, U, "[Zrodlo: Osoba A] Zespol: Osoba A (lider), Osoba B."],

    ["JB-03", "Dom Pomocy Spolecznej - Maslow k. Kielc", "Projekt koncepcyjny", "Projektant wiodacy", "Publiczny", "Osoba A", "Osoba A",
     "Wstrzymany", "Koncepcja", None, "Zolty",
     None, None, None, None, None, None, "PLN", None, None,
     None, "Maslow", None, None,
     "Inwestor prywatny", "Projekt koncepcyjny domu pomocy spolecznej.",
     None, U, "[Zrodlo: Osoba A] Wstrzymany (on hold), przyczyna nie podana w notatce zrodlowej."],
    ...
    ["JB-04", "Zabudowa wielorodzinna - Osiedle Siekierki", "Analiza urbanistyczna", "Analiza/doradztwo", "Mieszkaniowy", None, None,
     ...
     None, U, "[Zrodlo: Osoba A] W notatce zrodlowej osoba oznaczona jako 'J' - prawdopodobnie Osoba A, wymaga potwierdzenia. Inwestor nie podany - do uzupelnienia."],

    ["JB-05", "Projekt JB-05 (TBS)", "Nadzor autorski", "Nadzor autorski", "Mieszkaniowy", "Osoba A", "Osoba A",
     "Wstrzymany", "Budowa", None, "Zolty",
     None, None, None, None, None, None, "PLN", None, None,
     "ul. Przykladowa 3", "Warszawa", None, None,
     "Klient B sp. z o.o.", "Nadzor autorski na budowie dla Klient B sp. z o.o.",
     None, U, "[Zrodlo: Osoba A] Zespol: Osoba A (lider), Osoba B. Wstrzymany (on hold)."],

    ["WF-01", "Wieliszew", "Nadzor autorski", "Nadzor autorski", None, "Osoba D", "Osoba D",
     "W realizacji", "Budowa", None, "Zielony",
     None, None, None, None, None, None, "PLN", None, None,
     None, "Wieliszew", None, None,
     None, "Nadzor autorski na budowie.",
     None, U, "[Zrodlo: Osoba D] Przeglad kart materialowych zaproponowanych przez budowe co 1-2 tyg., wprowadzanie korekt / uzgadnianie zmian z inwestorem lub budowa. Same podroze na budowe odbywaja sie juz bardzo rzadko."],

    ["WF-02", "IChP", "Inne", None, None, "Osoba D", "Osoba D",
     ...
     None, U, "[Zrodlo: Osoba D] Zespol: Osoba D (lider), Osoba E (do pomocy). Temat konczacy sie, ale ma swoje mankamenty i jeszcze wracaja niezakonczone rzeczy."],

    ["WF-03", "GHS_3L - szklarnia", "Projekt budowlany", "Projektant wiodacy", "Komercyjny", "Osoba D", "Osoba D",
     ...
     None, U, "[Zrodlo: Osoba D] Zespol: Osoba D (lider), Osoba E. Na ten moment wstrzymany projekt do okolo 15.07.2026."],

    ["WF-04", "SKA", "Projekt wykonawczy", "Projektant wiodacy", None, "Osoba D", "Osoba D",
     "W realizacji", "Projektowanie", None, "Zolty",
     None, None, None, None, None, None, "PLN", None, None,
     None, None, None, None,
     None, "Projekt budowlany i projekt wykonawczy.",
     None, U, "[Zrodlo: Osoba D] Zespol: Osoba D (lider), Osoba F, Osoba E (dorywczo), + osoba do wnetrz (jeszcze do znalezienia). Dosc trudny projekt, ktory ma sporo mankamentow i sporo rzeczy do zrobienia."],

    ["WF-05", "NIK", "Projekt budowlany", "Projektant wiodacy", None, "Osoba D", "Osoba D",
     ...
     None, U, "[Zrodlo: Osoba D] Zespol: Osoba D (lider), Osoba E, Osoba G + ktos do pomocy (Osoba G ma 3 tyg. urlopu). Bardzo obszerny projekt, bardzo krotki czas realizacji - rozne etapy najlepiej przed 20.07.2026, calosc maks. do 31.08.2026."],

    ["GK-01", "99_OPS - Bemowo", "Projekt wykonawczy", "Nadzor autorski", None, "Osoba H", "Osoba H",
     "W realizacji", "Budowa", None, "Zielony",
     ...
     None, U, "[Zrodlo: Osoba H] Korespondencja i rozmowy telefoniczne z budowa, odpowiedzi na zapytania o informacje projektowa, wymagane zmiany w dokumentacji, uzupelnianie brakow, konsultowanie i akceptowanie rozwiazan zamiennych, kontakt z branzami, sporadyczne wizyty na budowie i koordynacjach. Termin zakonczenia prac przez GW: do konca 2026."],

    ["GK-02", "109_UCSL - Lublin", "Projekt wykonawczy", "Nadzor autorski", None, "Osoba H", "Osoba H",
     "W realizacji", "Budowa", None, "Zielony",
     None, dt.date(2026, 12, 31), None, None, None, None, "PLN", None, None,
     None, "Lublin", None, None,
     None, "Nadzor autorski w fazie budowy (projekt wykonawczy).",
     None, U, "[Zrodlo: Osoba H] Korespondencja i rozmowy z budowa, zmiany w dokumentacji, sporadyczne wizyty na budowie. Termin zakonczenia prac przez GW: do konca 2026."],

    ["GK-03", "93_SZDF - Siedlce", "Projekt wykonawczy", "Nadzor autorski", None, "Osoba H", "Osoba H",
     "W realizacji", "Budowa", None, "Zolty",
     None, None, None, None, None, None, "PLN", None, None,
     None, "Siedlce", None, None,
     None, "Nadzor autorski w fazie budowy (projekt wykonawczy).",
     None, U, "[Zrodlo: Osoba H] Korespondencja i rozmowy telefoniczne z inwestorem (nie budowa). Termin zakonczenia prac przez Inwestora nieznany."],

    ["GK-04", "90_BGM - Grodzisk Mazowiecki", "Projekt wykonawczy", "Nadzor autorski", None, "Osoba H", "Osoba H",
     ...
     None, U, "[Zrodlo: Osoba H] Zespol: Osoba H (samodzielnie), wspomagajaco Osoba I. Kontakt z inwestorem, ewentualne poprawki i uzupelnienia w przekazanej dokumentacji (projekt techniczny, zestawienie wyposazenia), odpowiedzi na pytania uczestnikow przetargu. Termin ogloszenia przetargu - wkrotce."],

    ["GK-05", "91_BSO - Sochaczew", "Projekt wykonawczy", "Nadzor autorski", None, "Osoba H", "Osoba H",
     "W realizacji", "Pozwolenia/Przetarg", None, "Zolty",
     None, None, None, None, None, None, "PLN", None, None,
     None, "Sochaczew", None, None,
     None, "Po pozwoleniu na budowe, przed przetargiem na Generalnego Wykonawce.",
     None, U, "[Zrodlo: Osoba H] Zespol: Osoba H (samodzielnie), wspomagajaco Osoba I. Jak wyzej (kontakt z inwestorem, poprawki dokumentacji, odpowiedzi na pytania oferentow). Termin ogloszenia przetargu - wkrotce."],
    ...
    ["MC-01", "LKW_LAKOWA - Siedlce", "Projekt techniczny (PT)", "Koordynacja branzowa", None, "Osoba J", "Osoba J",
     ...
     None, U, "[Zrodlo: Osoba J] Zespol: Osoba J."],

    ["MC-02", "WMA_MARZYCIELI - Warszawa", "Projekt budowlany", "Projektant wiodacy", None, "Osoba J", "Osoba J",
     "W realizacji", "Pozwolenia/Przetarg", None, "Zolty",
     None, None, None, None, None, None, "PLN", None, None,
     ...
     None, U, "[Zrodlo: Osoba J] Zespol: Osoba J (lider), Osoba K (rozmowy z inwestorem), Osoba L (dochodzaco)."],

    ["MC-03", "RMS_REMISZEWSKA / MYSZKOWSKA - Warszawa", "Projekt budowlany", "Projektant wiodacy", None, "Osoba J", "Osoba J",
     "W realizacji", "Zakonczenie", None, "Zielony",
     None, None, None, None, None, None, "PLN", None, None,
     None, "Warszawa", None, None,
     None, "Projekt budowlany (PB) - zakonczenie fazy projektowej (zmiany do PB).",
     None, U, "[Zrodlo: Osoba J] Zespol: Osoba J (lider), Osoba L (dochodzaco). Pozostaje zatwierdzenie przez inwestora i wydruk."],

    ["MC-04", "GRA_GRABIANOW - Siedlce", "Projekt koncepcyjny", "Projektant wiodacy", None, "Osoba J", "Osoba J",
     "Wstrzymany", "Koncepcja", None, "Zolty",
     None, None, None, None, None, None, "PLN", None, None,
     None, "Siedlce", None, None,
     None, "Projekt koncepcyjny (PK) przeslany do inwestora.",
     None, U, "[Zrodlo: Osoba J] Zespol: Osoba J. Czekamy na decyzje inwestora o dalszych krokach w projekcie."],

    ["MC-05", "TBS Pomorska - Warszawa", "Projekt koncepcyjny", "Projektant wiodacy", "Mieszkaniowy", "Osoba J", "Osoba J",
     "Planowanie", "Koncepcja", None, "Zielony",
     None, None, None, None, None, None, "PLN", None, None,
     None, "Warszawa", None, None,
     "TBS (nazwa do potwierdzenia)", "Projekt koncepcyjny (PK) - zapoznanie sie z projektem.",
     None, U, "[Zrodlo: Osoba J] Zespol: Osoba J + zespol do skompletowania. Duzy temat."],
]
